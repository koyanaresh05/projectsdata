...
const newpassword = doc.new_password;
const emp_id = doc.Employee_id;
const query = { "Employee_id": emp_id};
const update = {
  "$set": {
    "Password": newpassword //I can use seperate doc with "type": "forgot_pass" and then use its "password" field which would have been updated from different function
  }
};
