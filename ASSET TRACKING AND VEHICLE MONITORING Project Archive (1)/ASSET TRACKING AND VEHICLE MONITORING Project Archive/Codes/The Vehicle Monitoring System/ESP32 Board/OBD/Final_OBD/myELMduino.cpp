...
uint64_t ELM327::findResponse()
{
  ...
  if (debugMode)
  {
     res_header[0] = header[0];           /*Line added by shubham kumar saurav*/
     res_header[1] = header[1];           /*Line added by shubham kumar saurav*/
     res_header[2] = header[2];           /*Line added by shubham kumar saurav*/
     res_header[3] = header[3];           /*Line added by shubham kumar saurav*/
     res_header[4] = header[4];           /*Line added by shubham kumar saurav*/
     res_header[5] = header[5];           /*Line added by shubham kumar saurav*/
     res_header[6] = header[6];           /*Line added by shubham kumar saurav*/
